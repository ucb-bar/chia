#!/usr/bin/env bash
#
# Bring the local Ollama test cluster up/down using YOUR currently-active
...
#   ./ollama_cluster.sh up      # also: up --dry-run
#   ./ollama_cluster.sh down
#
...
echo "[ollama-cluster] head env activation: ${CHIA_HEAD_ENV_SETUP}"
