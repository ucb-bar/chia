#!/usr/bin/env bash
#
# Bring the local chipyard test cluster up/down using YOUR currently-active
...
#   ./chipyard_cluster.sh up    # also: up --dry-run
#   ./chipyard_cluster.sh down
#
...
# .../chia/chipyard/test/cluster -> repo root is 5 levels up
REPO_ROOT="$(cd "$HERE/../../../.." && pwd)"
YAML="$HERE/chipyard_local.yaml"
...
echo "[chipyard-cluster] head env activation: ${CHIA_HEAD_ENV_SETUP}"
